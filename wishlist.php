...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="hidden" name="wishlist_id" value="<?= $fetch_wishlist[
          'id'
      ] ?>">
      <input type="hidden" name="name" value="<?= $fetch_wishlist['name'] ?>">
      <input type="hidden" name="price" value="<?= $fetch_wishlist['price'] ?>">
      <input type="hidden" name="image" value="<?= $fetch_wishlist['image'] ?>">
      <a href="quick_view.php?pid=<?= $fetch_wishlist[
          'pid'
      ] ?>" class="fas fa-eye"></a>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= $grand_total > 1
          ? ''
          : 'disabled' ?>" onclick="return confirm('delete all from wishlist?');">delete all item</a>
   </div>
